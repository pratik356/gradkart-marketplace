...
import { ArrowLeft, MapPin, CreditCard, Truck, User, Shield, CheckCircle, MessageCircle } from "lucide-react"
...
export default function CheckoutPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Show chat availability notification
      toast({
        title: "Order Placed Successfully! 🎉",
        description: "Chat with the seller is now available for further communication.",
        duration: 5000,
      })

  ...
  useEffect(() => {
    ...
    if (userStatus === "approved" || user.status === "approved") {
      ...
      if (listingsData) {
        ...
        const nearbyListings = activeListings.filter((l: any) => true) // simulate distance
    ...
    return (
      <div className="min-h-screen bg-accent flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-600 mb-4">Please set your location to see items near you</p>
      ...
      <div className="gradient-bg p-4 pb-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div>
              <h1 className="text-white text-xl font-bold">Hi, {firstName || "Student"}!</h1>
              <LocationHeader className="text-white/80" showDeliveryStatus={false} locationName={userLocation?.name} />
            </div>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center overflow-hidden">
              {avatarUrl ? (
                <img src={avatarUrl} alt="Student Avatar" className="w-full h-full object-cover rounded-full" />
              ) : (
                <div className="text-sm font-bold text-primary">
                  {firstName ? firstName[0].toUpperCase() : "S"}{lastName ? lastName[0].toUpperCase() : ""}
                </div>
              )}
            </div>
          </div>
